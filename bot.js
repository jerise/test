...
///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
client.once('ready', () => {///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
    console.log(chalk.greenBright.underline("\nBot online.\n"));
    client.user.setGame(null);///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
});///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes

client.on('message', (message) => {///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes

    let args = message.content.split(" ");///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
    let command = args.shift().slice(config.bot.prefix.length);///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes

    let inVoiceChannel;///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes

    if (!message.content.startsWith(config.bot.prefix)) return;///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
...
///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
        ...
        case "play":///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
            ...
            message.channel.send(":mag_right: Searching...").then(msg => {
                        ...
                        yt.getInfo(s, (err, data) => {
                            ...
                            if (playlist.length === 1) {
                                ...
                                if (!playing && !inVoiceChannel) {
                                    ...
                                    play(message);///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
                                }
                            }
                        });
                    } catch (err) {
                ...
                } else {///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
...
function play(message) {    
    //client.user.setGame(null);
    playing = false;///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
    ...
    collector.on("collect", m => {
        ...
        switch (cmd) {
            ...
            case "skip":
                ...
                break;///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
            case "song":///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
    ...
    dispatcher.on("end", () => {///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
        collector.stop();
        playing = false;
        client.user.setGame(null);
        playlist.shift();
...
client.login(process.env.BOT_TOKEN);///////////////////////By:- Mál ,ϻά𝔥𝔪𝔬𝔲𝓓-QuaStyle≽ܫ≼#9115///// By:- Mál , Galal . 🚀#1381//////Mal Codes
